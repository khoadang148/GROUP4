...
import { DownOutlined, LockOutlined, CreditCardOutlined, BankOutlined } from '@ant-design/icons';
...
const Checkout = () => {
  ...
  const Paypal =() => {
    return(
      <div>
        <div className="mt-8">
          <p className="text-[14px] text-[#686F7A]">After payment via PayPal's secure checkout, we will send you a link to download your files.</p>
        </div>
      ...
      <div className='flex mt-10 justify-center gap-x-5 mr-16'>
        <div className='bg-white w-[750px] h-auto'>
          <div className='mt-6 ml-5'>
            <h1 className="text-xl font-bold mb-4 text-center md:text-left text-black">Our Origins</h1>
          ...
          <div className='mt-8'>
            <div className='relative w-auto overflow-hidden mb-6'>
              ...
              <div className='bg-white h-10 w-full pl-5 flex items-center'>
                <h1 className='text-lg font-semibold text-black'>Edit Address</h1>
              </div>
              ...
              <h1 className='text-black '>Academy Name*</h1>
                ...
                />
                <p className='text-[#686F7A] text-[13px]'>If you want your invoices addressed to a academy. Leave blank to use your full name.</p>
              </div>
              <div className='mt-10'>
              ...
              <h1 className='text-black '>Address2*</h1>
                ...
                <div className="flex gap-20 ml-5 mt-10">
                  ...
                  <div>
                    <h1 className='text-black '>State / Province / Region*</h1>
                    <input
                ...
                <div className="flex gap-20 ml-5 mt-10">
                  ...
                  <button className="mt-8 ml-5 bg-[#ed2a26] text-white text-[15px] px-7 py-3 hover:bg-[#333333] transition duration-300 rounded-lg">
                    Save Changes
                  </button>
              </div>
            </div>
          ...
          <div className='text-[#787878] bg-white h-auto w-[320px] mt-5 ml-5'>
              <p>Joginder Singh</p>
              <p>#1234 Street No. 45, Ward No. 60, Phase 3, Shahid Karnail Singh Nagar, Near Pakhowal Road.</p>
        ...
        <div className='bg-white w-[350px] h-[330px] '>
          <div className='mt-6 ml-5'>
            <h1 className="text-xl font-bold mb-4 text-center md:text-left text-black">Order Summary</h1>
            <div className="w-10 h-0.5 bg-red-600 mb-4 mx-auto md:mx-0"></div>
          </div>
          <div className='mt-6 ml-5'>
            <div className='flex'>
              <h1 className="text-[16px] font-bold mb-4 text-center md:text-left text-black">Baby Plan</h1>
              <p className='text-[#686F7A] text-[16px] ml-auto mr-5'>$49</p>
            </div>
            <hr className="my-2 w-[310px] border-gray-300" />
          </div>
          <div className='mt-6 ml-5'>
            <div className='flex'>
              <h1 className="text-[16px] font-bold mb-4 text-center md:text-left text-[#686F7A]">Taxes(GST)</h1>
              <p className='text-[#686F7A] text-[16px] ml-auto mr-5'>$2</p>
            </div>
            <hr className="my-2 w-[310px] border-gray-300" />
          </div>
          <div className='mt-6 ml-5'>
            <div className='flex'>
              <h1 className="text-[18px] font-bold mb-4 text-center md:text-left text-black">Total</h1>
              <p className='text-black text-[18px] ml-auto mr-5'>$51</p>
            </div>
            <hr className="my-2 w-[310px] border-gray-300" />
          </div>
          <div className='text-center mt-5 '>
            <h1 className='text-[#686F7A] text-[16px]'><LockOutlined className='mr-2'/>Secure checkout</h1>
          </div>
        </div>
      </div>
        ...
        <div className='bg-white w-[750px] h-auto mt-10 pb-8'>
          ...
          <div className='flex justify-center text-black text-[18px]'>
            <div className="bg-white">
              ...
              <Button
                className={`w-[230px] h-[50px] bg-[#f3f2f2] text-center  ${
                  activeTab === "bank" ? " text-red-500 border-b-2 border-red-500" : ""
                }`}
              ...
              <Button
                className={`w-[230px] h-[50px] bg-[#f3f2f2] text-center ${
                  activeTab === "paypal" ? " text-red-500 border-b-2 w-[230px] border-red-500 " : ""
                }`}
          ...
          <div className='mt-6 ml-5'>
            <h1 className="text-xl font-bold mb-4 text-center md:text-left text-black">Order Details</h1>
            <div className="w-10 h-0.5 bg-red-600 mb-4 mx-auto md:mx-0"></div>
          </div>
          <div className='mt-6 ml-5'>
            <div className='flex'>
