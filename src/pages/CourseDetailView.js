...
const CourseDetailView = ({ sidebar }) => {
  ...
  const Reviews = () => {
    ...
    return (
      <div>
        <div className="flex gap-x-10 justify-center mt-8 ml-9">
          <div
            className={`bg-white h-[280px] ml-[-400px] mt-5 px-4  ${
              sidebar ? "w-[450px] " : "w-[500px] "
            }`}
          >
            <div className="text-[20px] mt-4 ml-1">
            ...
            <div className="w-full h-14 bg-[#F7F7F7] border">
              <div className="ml-6 pt-4 text-yellow-500 text-[20px] flex gap-3">
                ...
                <FontAwesomeIcon icon={faStar} />
                <FontAwesomeIcon icon={faStar} />
                <p className="text-black ml-2 mt-1 font-medium text-[13px]">
                  Course Rating
                </p>
              </div>
            </div>
            <div className="mt-5">
              <div className="flex">
                ...
                <div className="ml-6 text-yellow-500 text-[20px] flex gap-1">
                  ...
                  <p className="text-[#333333] font-medium text-[14px] ml-2">
                    70%
                  </p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-6 text-yellow-500 text-[20px] flex gap-1">
                  ...
                  <p className="text-[#333333] font-medium text-[14px] ml-2 mt-1">
                    5%
                  </p>
                </div>
              </div>
          ...
          <div className={`p-2 ${sidebar ? "w-[700px]" : "w-[900px]"}`}>
            <div>
            ...
            {filteredCourses.map((course, index) => (
              <div key={index} className="bg-white mt-8 pb-4">
                <div>
                  <div className="flex gap-3 mt-6 p-2 ml-4">
                    <div>
                      <img src={course.img} width={60} alt="img9" />
                    </div>
                    <div className="flex flex-col">
                      <h3 className="text-[16px] font-medium">{course.name}</h3>
