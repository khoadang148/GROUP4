...
const Payout = ({sidebar}) => {
  return (
    ...
    >
        ...
        {/* ///////////////////////////////// */}
        <div className={` flex gap-6 mt-10 ${sidebar?"w-[1500px]":"w-[1850px]"}`}>
            <div className={`bg-[#FFFFFF] border border-solid ${sidebar?"w-[520px]":"w-[700px]"}`} >
        ...
        <div 
        className={`bg-[#FFFFFF]  border border-solid mt-10 ${sidebar?"w-[520px]":"w-[700px]"}`}
        >
                <h3 className='p-5 border border-solid mb-0'>Payout account</h3>
                <div className='p-5 border-l-[1px] border-r-[1px] border-solid'>
                   <img src='https://logos-download.com/wp-content/uploads/2016/11/Payoneer_logo_logotype.png' alt='svg' width={90}/>
                ...
                <div className=' p-5 border border-solid '>
                   <button className='bg-[#ED2A26] hover:bg-black p-3 w-[475px] text-white font-medium rounded-sm'>Set Account</button>
                </div>
            </div>
