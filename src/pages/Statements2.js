...
const Statements2 = ({ sidebar }) => {
  ...
  <div className="grid grid-cols-1">
    <div className="flex flex-col md:flex-row gap-6 p-3">
      <div className="md:w-2/3 rounded-sm bg-white text-black font-medium p-4">
        ...
        <h1 class="text-gray-500">If you are not an instructor, you can't use this section.</h1>
        <button class="bg-red-600 text-white font-bold py-2 px-4 rounded mt-4">Become a Instructor</button>
      </div>
  ...
  <div className="flex items-center py-3 px-4">
    ...
    <div className="px-4">
      ...
      />
      <button className="bg-red-600 hover:bg-blue-600 text-white font-bold py-2 px-3 rounded-md ml-2">
        Search
      </button>
    </div>
  </div>
